...
class _FamilyScreenState extends State<FamilyScreen> {
  ...
  Widget _buildWordCard(BuildContext context, int index) {
    ...
    // Colores cíclicos para cada tarjeta — más visual
    const cardColors = [
      Color(0xFF0099B3), Color(0xFFDB2777), Color(0xFF059669), Color(0xFF7C3AED),
      Color(0xFFD97706), Color(0xFF0099B3), Color(0xFFDB2777), Color(0xFF059669),
      Color(0xFF7C3AED), Color(0xFFD97706), Color(0xFF0099B3), Color(0xFFDB2777),
    ];
